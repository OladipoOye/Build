...
class HomeGame(Game):
    ...
    def __repr__(self, option='standard'):
        if option == 'standard':
            ...
            return f"Home game {self.game_id} away against {self.opps}. Offensive stats are: {self.rebounds} rebounds, {self.assists} assists, {self.turnovers} turnovers, {self.calc_points()} points, {self.three_point_percentage()*100}% from 3pt range, {self.ts_percentage()*100}% true shooting"
...
class AwayGame(Game):
    ...
    def __repr__(self, option='standard'):
        if option == 'standard':
            ...
            return f"Away game {self.game_id} against {self.opps}. Offensive stats are: {self.rebounds} rebounds, {self.assists} assists, {self.turnovers} turnovers, {self.calc_points()} points, {self.three_point_percentage()*100}% from 3pt range, {self.ts_percentage()*100}% true shooting"
        elif option == 'defensive':
...
class VarsityGame(Game):
    ...
    def __repr__(self, option='standard'):
        if option == 'standard':
            ...
            return f"Varsity game {self.game_id} against {self.opps}. Offensive stats are: {self.rebounds} rebounds, {self.assists} assists, {self.turnovers} turnovers, {self.calc_points()} points, {self.three_point_percentage()*100}% from 3pt range, {self.ts_percentage()*100}% true shooting"
        elif option == 'defensive':
